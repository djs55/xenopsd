...
(* OASIS_START *)
(* DO NOT EDIT (digest: f65283438d32d34e3105bf4a76e1509a) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build server with xen support";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build server with xenlight support";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build server with libvirt support";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "xenopsd";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "suspend_image_viewer";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "suspend_image_viewer.ml"
                   });
               Executable
                 ({
                     cs_name = "xenopsd_xc_main";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["fsync_stubs.c"; "xenctrlext_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = true; exec_main_is = "xenops_xc_main.ml"});
               Executable
                 ({
                     cs_name = "watch_test";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "watch_test.ml"});
               Executable
                 ({
                     cs_name = "xenopsd_simulator";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "simulator", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "simulator";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "xenopsd"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "xenops_simulator_main.ml"
                   });
               Executable
                 ({
                     cs_name = "xenopsd_libvirt_main";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "xenops_libvirt_main.ml"
                   });
               Executable
                 ({
                     cs_name = "xenopsd_xenlight_main";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("xenlight", None);
                           FindlibPackage ("xenlight.xentoollog", None);
                           FindlibPackage ("xenctrl", None);
                           InternalLibrary "xenopsd";
                           FindlibPackage ("xenstore", None);
                           FindlibPackage ("xenstore.unix", None);
                   ...
                   {exec_custom = true; exec_main_is = "xenops_xl_main.ml"})
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\246\161\144\175\191\019\237\025@\216c$\223\175@l";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
